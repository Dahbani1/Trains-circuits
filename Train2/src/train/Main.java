...
public class Main {
	public static void main(String[] args) {
		...
		StationInter B= new StationInter("GareB", 4, 0);
		StationInter C= new StationInter("GareC", 4, 0);

		Section AB = new Section("AB");
		Section BC = new Section("BC");
		Section CD = new Section("CD");
		Railway r = new Railway(new Element[] { A, AB,B, BC,C, CD, D }, new Station[] { A,B,C,D });
